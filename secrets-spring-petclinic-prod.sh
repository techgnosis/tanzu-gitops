...
--dry-run=client \
-o json | kubeseal > manifests/spring-petclinic-prod/wavefront-secrets.json
...
--dry-run=client \
-o json | kubeseal > manifests/spring-petclinic-prod/argo-rollouts-wavefront.json
...
--key=./tls.key \
--dry-run=client \
-o json | kubeseal > manifests/spring-petclinic-prod/ingress-tls.json
