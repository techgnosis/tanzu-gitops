...
POSTGRES_DIR="postgres-for-kubernetes-v1.1.0"
...
tar -xvf postgres-for-kubernetes-v1.1.0.tar.gz

docker load -i $POSTGRES_DIR/images/postgres-instance
docker load -i $POSTGRES_DIR/images/postgres-operator

docker tag postgres-instance:v1.1.0 $HARBOR_DOMAIN/library/postgres-instance:v1.1.0
docker tag postgres-operator:v1.1.0 $HARBOR_DOMAIN/library/postgres-operator:v1.1.0

docker push $HARBOR_DOMAIN/library/postgres-instance:v1.1.0
docker push $HARBOR_DOMAIN/library/postgres-operator:v1.1.0
